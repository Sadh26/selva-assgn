...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="SumOfFactorials" Type="Folder">
				<Item Name="Tests" Type="Folder">
					<Item Name="SumOfFactorialsTests.lvlib" Type="Library" URL="../Tests/SumOfFactorialsTests.lvlib"/>
					<Item Name="test_sum.txt" Type="Document" URL="../Tests/test_sum.txt"/>
				</Item>
				<Item Name="Drona.ini" Type="Document" URL="../Drona.ini"/>
				<Item Name="SumOfFactorials.vi" Type="VI" URL="../SumOfFactorials.vi"/>
			</Item>
		</Item>
